...
#include "../../src/lte/model/lte-handover-algorithm.h"
#include "../../src/lte/model/lte-handover-management-sap.h"
#include "../../src/lte/model/lte-rrc-sap.h"
 ...
 *
 *     lteHelper->SetHandoverAlgorithmType ("ns3::MyHandOverAlgorithm");
 ...
 */
class MyHandOverAlgorithm : public LteHandoverAlgorithm
{
  public:
    /// Creates a strongest cell handover algorithm instance.
    MyHandOverAlgorithm();

    ~MyHandOverAlgorithm() override;
    ...
    friend class MemberLteHandoverManagementSapProvider<MyHandOverAlgorithm>;
...
}; // end of class MyHandOverAlgorithm
